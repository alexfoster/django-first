...
from .views import (StartupCreate, StartupUpdate, StartupDelete, TagCreate, TagUpdate, TagDelete, NewsLinkCreate, NewsLinkUpdate, NewsLinkDelete, startup_detail, startup_list, tag_detail, tag_list)
